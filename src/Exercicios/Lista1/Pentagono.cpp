...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.0f, 0.7f, 1.0f, 1.0f); // cor do pentágono
		glLineWidth(3);
		glDrawArrays(GL_LINE_LOOP, 0, 6); // 6 = N+1, para fechar o pentágono
...
int setupGeometry()
{
    const int N = 5; // Número de lados do pentágono
    const float PI = 3.14159265358979323846f;
    float raio = 0.5f;
    float centro_x = 0.0f, centro_y = 0.0f;

    // +1 para fechar o pentágono
